...
export const deleteCustomer =
  async (customerId) => {
    ...
    try {
      ...
      const response =
        await customerReportApi.delete(
          `/customer-reports/${customerId}`
        );
...
export const activateCustomer =
  async (customerId) => {
    ...
    try {
      ...
      const response =
        await customerReportApi.patch(
          `/customer-reports/${customerId}/activate`
        );
...
export const deactivateCustomer =
  async (customerId) => {
    ...
    try {
      ...
      const response =
        await customerReportApi.patch(
          `/customer-reports/${customerId}/deactivate`
        );
