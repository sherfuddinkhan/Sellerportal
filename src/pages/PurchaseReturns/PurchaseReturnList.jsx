...
const PurchaseReturnList = () => {
    ...
    const filteredPurchaseReturns = useMemo(() => {
        ...
        return purchaseReturns.filter((item) => (
            ...
            String(item.PurchaseReturnId).includes(search) ||

            String(item.PurchaseOrderId).includes(search) ||

            String(item.GoodsReceiptNoteId).includes(search) ||

            String(item.SupplierId).includes(search) ||
