...
app.delete(
    ...
    async (req, res) => {
        ...
        try {
            ...
            console.error(
                "DELETE /api/product-images Error:",
                error.message
            );
